...
export const routes01AprendiendoJQuery = [
    ...
    {
        id: 'efectosAnimacionesJQuery',
        urlLayoutHeader: '/01-udemy/01-jquery-master-javascript-clasico/src/components-layout/layout-header.html',
        urlLayoutNavbar: '/01-udemy/01-jquery-master-javascript-clasico/src/components-layout/layout-navbar.html',
        urlLayoutMain: '/01-udemy/01-jquery-master-javascript-clasico/src/pages/01-aprendiendo-jquery/04-jquery-efectos-y-animaciones.html',
        urlLayoutFooter: '/01-udemy/01-jquery-master-javascript-clasico/src/components-layout/layout-footer.html',
        favicon: '/01-udemy/01-jquery-master-javascript-clasico/assets/favicon/jquery-favicon.ico',
        pageTitle: 'Aprendiendo jQuery - Efectos y Animaciones',
        path: '/aprendiendo-jquery/efectos-animaciones/',
        headerTitle: 'Aprendiendo jQuery - 4. Efectos y Animaciones',
        styles: '/01-udemy/01-jquery-master-javascript-clasico/src/styles/01-jquery/04-jquery-efectos-y-animaciones.css',
        scripts: [
            '/01-udemy/01-jquery-master-javascript-clasico/src/scripts/01-aprendiendo-jquery/04-jquery-efectos-y-animaciones.js'
        ]
    },

    {
        ...
        urlLayoutHeader: '/01-udemy/01-jquery-master-javascript-clasico/src/components-layout/layout-header.html',
        urlLayoutNavbar: '/01-udemy/01-jquery-master-javascript-clasico/src/components-layout/layout-navbar.html',
        urlLayoutMain: '/01-udemy/01-jquery-master-javascript-clasico/src/pages/01-aprendiendo-jquery/05-jquery-peticiones-ajax.html',
        urlLayoutFooter: '/01-udemy/01-jquery-master-javascript-clasico/src/components-layout/layout-footer.html',
        favicon: '/01-udemy/01-jquery-master-javascript-clasico/assets/favicon/jquery-favicon.ico',
        pageTitle: 'Aprendiendo jQuery - Peticiones Ajax',
        path: '/aprendiendo-jquery/peticiones-ajax/',
        headerTitle: 'Aprendiendo jQuery - 5. Peticiones Ajax',
        styles: '/01-udemy/01-jquery-master-javascript-clasico/src/styles/01-jquery/05-jquery-peticiones-ajax.css',
        scripts: [
            '/01-udemy/01-jquery-master-javascript-clasico/src/scripts/01-aprendiendo-jquery/05-jquery-peticiones-ajax.js'
        ]
    },
