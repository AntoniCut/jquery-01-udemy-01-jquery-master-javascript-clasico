...
/**
 *  - `Array de objetos de tipo Route` que definen las `rutas de la aplicación SPA` de Aprendiendo jQuery UI.
...
export const routes02AprendiendoJQueryUI = [

    {
        ...
        urlLayoutMain: '/01-udemy/01-jquery-master-javascript-clasico/src/pages/02-aprendiendo-jquery-ui/01-primeros-pasos.html',
...

    {
        ...
        urlLayoutHeader: '/01-udemy/01-jquery-master-javascript-clasico/src/components-layout/layout-header.html',
        urlLayoutNavbar: '/01-udemy/01-jquery-master-javascript-clasico/src/components-layout/layout-navbar.html',
        urlLayoutMain: '/01-udemy/01-jquery-master-javascript-clasico/src/pages/02-aprendiendo-jquery-ui/02-interacciones.html',
        urlLayoutFooter: '/01-udemy/01-jquery-master-javascript-clasico/src/components-layout/layout-footer.html',
        favicon: '/01-udemy/01-jquery-master-javascript-clasico/assets/favicon/jquery-favicon.ico',
...

    {
        ...
        urlLayoutHeader: '/01-udemy/01-jquery-master-javascript-clasico/src/components-layout/layout-header.html',
        urlLayoutNavbar: '/01-udemy/01-jquery-master-javascript-clasico/src/components-layout/layout-navbar.html',
        urlLayoutMain: '/01-udemy/01-jquery-master-javascript-clasico/src/pages/02-aprendiendo-jquery-ui/03-animaciones-y-efectos.html',
        urlLayoutFooter: '/01-udemy/01-jquery-master-javascript-clasico/src/components-layout/layout-footer.html',
        favicon: '/01-udemy/01-jquery-master-javascript-clasico/assets/favicon/jquery-favicon.ico',
...

    {
        ...
        urlLayoutHeader: '/01-udemy/01-jquery-master-javascript-clasico/src/components-layout/layout-header.html',
        urlLayoutNavbar: '/01-udemy/01-jquery-master-javascript-clasico/src/components-layout/layout-navbar.html',
        urlLayoutMain: '/01-udemy/01-jquery-master-javascript-clasico/src/pages/02-aprendiendo-jquery-ui/04-plugins-y-widgets.html',
        urlLayoutFooter: '/01-udemy/01-jquery-master-javascript-clasico/src/components-layout/layout-footer.html',
        favicon: '/01-udemy/01-jquery-master-javascript-clasico/assets/favicon/jquery-favicon.ico',
